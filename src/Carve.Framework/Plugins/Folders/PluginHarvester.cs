...
using Carve.Utility.Extensions;
using System;
...
namespace Carve.Plugins.Folders
{
    public class PluginHarvester:IPluginHarvester
    {
        ...
        //public PluginHarvester(ICacheManager cacheManager, IWebSiteFolder webSiteFolder, ICriticalErrorProvider criticalErrorProvider)
        //{
        ...
        public IEnumerable<PluginDescriptor> HarvestPlugins(IEnumerable<string> paths, string pluginType, string manifestName, bool manifestIsOptional)
        {
            return paths
                .SelectMany(path => HarvestExtensions(path, pluginType, manifestName, manifestIsOptional))
                .ToList();
        }

        private IEnumerable<PluginDescriptor> HarvestExtensions(string path, string extensionType, string manifestName, bool manifestIsOptional)
        {
        ...
        private List<PluginDescriptor> AvailableExtensionsInFolder(string path, string extensionType, string manifestName, bool manifestIsOptional)
        {
        ...
        public static PluginDescriptor GetDescriptorForExtension(string locationPath, string extensionId, string extensionType, string manifestText)
        {
            ...
            pluginDescriptor.Features = GetFeaturesForExtension(manifest, pluginDescriptor);

            return pluginDescriptor;
        }

        private PluginDescriptor GetExtensionDescriptor(string locationPath, string extensionId, string extensionType, string manifestPath, bool manifestIsOptional)
        {
        ...
        private static IEnumerable<FeatureDescriptor> GetFeaturesForExtension(IDictionary<string, string> manifest, PluginDescriptor extensionDescriptor)
        {

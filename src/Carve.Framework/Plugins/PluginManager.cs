...
namespace Carve.Plugins
{
    public class PluginManager: IPluginManager
    {
        ...
        // the filesystem. 
        public PluginDescriptor GetExtension(string id)
        {
        ...
        {
            var extensionDescriptor = featureDescriptor.Plugin;
            var featureId = featureDescriptor.Id;
            var extensionId = extensionDescriptor.Id;

            PluginEntry extensionEntry;
            try
            {
        ...
        private PluginEntry BuildEntry(PluginDescriptor descriptor)
        {
            foreach (var loader in _loaders)
            {
